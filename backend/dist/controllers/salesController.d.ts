...
export declare const updateSalesInvoice: (req: Request, res: Response) => Promise<void>;
export declare const deleteSalesInvoice: (req: Request, res: Response) => Promise<void>;
